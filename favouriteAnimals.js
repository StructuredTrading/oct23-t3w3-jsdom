...
realFormInput.addEventListener("focusin", () => {
    inputHelperReveal("realform-hint");
});
realFormInput.addEventListener("focusout", () => {
    inputHelperHide("realform-hint");
});
inputHelperHide("realform-hint");

let fakeFormInput = document.getElementById("fakeform-addAnimal");
fakeFormInput.addEventListener("focusin", () => {
    inputHelperReveal("fakeform-hint");
});
fakeFormInput.addEventListener("focusout", () => {
